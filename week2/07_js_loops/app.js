...
const foodsA = ["pizza", "chocolate", "ice cream", "cheese"];
for (let i = 0; i < foodsA.length; i++) {
  console.log(foodsA[i]);
}
...
const foodsB = ["pizza", "chocolate", "ice cream", "cheese"];
for (let food of foodsB) {
  console.log(food);
}
...
const foodsC = ["pizza", "chocolate", "ice cream", "cheese"];
foodsC.forEach(function (food) {
  console.log(food);
});
...
const favAnimals = ["cheetah","tiger","leopard","lynx","panther"];
...
const favColours = ["blue","green","red","silver","gold","red"];
favColours.forEach(function(colour) {
    console.log(colour);    
});
